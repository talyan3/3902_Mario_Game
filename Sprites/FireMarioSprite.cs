...
namespace MonogameTest
{
    public class FireMarioSprite : StaticSprite
    {
        ...
        public FireMarioSprite(GraphicsDevice graphicsDevice)
        {
            Texture2D texture = Texture2D.FromFile(graphicsDevice, "FireMario.png");

            _runFrames.Add(new TextureRegion(texture, 102, 0, FrameW, FrameH));
            _runFrames.Add(new TextureRegion(texture, 128, 0, FrameW, FrameH));
            _runFrames.Add(new TextureRegion(texture, 152, 0, FrameW, FrameH));

            _crouchFrame = new TextureRegion(texture, 0, 0, FrameW, FrameH);
            _jumpFrame = new TextureRegion(texture, 27, 0, FrameW, FrameH);
            _idleFrame = new TextureRegion(texture, 180, 0, FrameW, FrameH);
