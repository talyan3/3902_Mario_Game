...
namespace MonogameTest.Screens
{
    public class HUDScreen
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(_coinTexture, new Vector2(330, 45), null, Color.White, 0f,
                Vector2.Zero, 3f, SpriteEffects.None, 0f);
            spriteBatch.DrawString(_font, "x" + coins, new Vector2(375, 55), Color.White);

            spriteBatch.DrawString(_font, "WORLD", new Vector2(550, 15), Color.White);
            spriteBatch.DrawString(_font, world, new Vector2(580, 55), Color.White);

            spriteBatch.DrawString(_font, "TIME", new Vector2(800, 15), Color.White);
            spriteBatch.DrawString(_font, time, new Vector2(825, 55), Color.White);
        }
    }
}
